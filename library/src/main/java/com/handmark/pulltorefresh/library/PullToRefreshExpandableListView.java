...
public class PullToRefreshExpandableListView extends PullToRefreshAdapterViewBase<ExpandableListView>
{
	...
	public void SetOnChildClickListener(OnChildClickListener onChildClickListener) {
		lv.setOnChildClickListener(onChildClickListener);
	}

	public void setGroupIndicator(Drawable drawable)
	{
		lv.setGroupIndicator(drawable);
	}

	public boolean collapseGroup(int groupPosition)
	{
		return lv.collapseGroup(groupPosition);
	}

	public boolean expandGroup(int groupPosition)
	{
		return lv.expandGroup(groupPosition);
	}

	public boolean isGroupExpanded(int groupPosition)
	{
		return lv.isGroupExpanded(groupPosition);
	}
